...
We get the same numbers.  So why are we not supposed to use logFC as a filter?
```{r signfiltlfc}
...
The practice of using logFC as a filter BEFOFE our multiple test correction is invalid. I would expect the number of significant results to increase if I filter on logFC before I correct for multiple testing.
```{r badpractice}
