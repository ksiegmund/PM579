...
We want to simulate data under the null, so let's simulate 6 independent observations, 3 per treatment group.  
...
Let's check:
```{r }  
smoothScatter( gp1_sd,gp2_sd  ,nrpoints=500)
