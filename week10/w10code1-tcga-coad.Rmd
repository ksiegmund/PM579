---
title: "Analysis of TCGA colon adenocarcinoma (COAD)"
author: "ks"
date: "`r Sys.Date()`"
...
```{r fraction-xychrfeatures}
sum(is.element(coad$fdnam$Chr,c("X","Y"))/length(coad$fdnam$Chr))
```

Just $7.6\%$ of the features are on X and Y chromosomes but when we filter on variance, we're selecting these into our analysis set  and they will have a large impact on the cluster results. Let's drop the features on the X and Y chromosomes before performing our dimension reduction techniques.
