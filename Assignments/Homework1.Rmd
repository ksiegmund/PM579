...
Now you've seen how RMarkdown can be used to create code for reproducible research. Why might a result might NOT be reproducible? 
...
Please turn in both your Homework1.Rmd file as well as the *.html output using GitHub. You will need to follow steps 3-5 given at the website listed above.
