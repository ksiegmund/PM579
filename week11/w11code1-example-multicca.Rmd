...
How many variables are selected from each of the 3 blocks of data? Consider just the first canonical variable.
```{r}
sum(out$ws[[1]][,1]!=0)
sum(out$ws[[2]][,1]!=0)
sum(out$ws[[3]][,1]!=0)
...
How many of the first 25 variables contribute to the 1st canonical variable?
```{r}
