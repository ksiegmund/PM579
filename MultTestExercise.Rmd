...
# [1000 x 50] in males
sim_male   <- replicate(50,rnorm(n = 1000, mean = 6, sd = 1))
# [1000 x 50] in females
sim_female <- replicate(50,rnorm(n = 1000, mean = 6.3, sd = 1))
mx <- cbind(sim_male,sim_female)
...
```{r 1gfpr}
trtgp <- rep(c(0,1),each=50)
sim_male <- replicate(100,rnorm(n = 1000, mean = 6, sd = 1))

tt=genefilter::rowttests(sim_male,factor(trtgp))
```
